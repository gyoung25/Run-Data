...
def stratify_pace_by_elevation(mergedData, numInts = 3):
...
def plot_pace_by_elevation(mergedData, numInts = 3):
    import numpy as np
    import matplotlib.pyplot as plt
    from numpy.polynomial import polynomial as P
    
    stratPaceByElev = stratify_pace_by_elevation(mergedData, numInts)
...
def regression_slope_over_elevation(mergedData, numInts):
...
def plot_regression_slopes(mergedData, numInts):
    
    import matplotlib.pyplot as plt
    
    slopes, elevStrats = regression_slope_over_elevation(mergedData, numInts)
